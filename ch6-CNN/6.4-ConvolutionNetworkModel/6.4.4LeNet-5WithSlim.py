...
def inference(input_tensor, regularizer):
    with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d], padding='SAME'):
        conv1 = slim.conv2d(input_tensor, CONV1_DEEP, [CONV1_SIZE, CONV1_SIZE], scope='layer1-conv1', stride=1)
        pool1 = slim.max_pool2d(conv1, [2, 2], scope='layer2-pool1', stride=2)
        conv2 = slim.conv2d(pool1, CONV2_DEEP, [CONV2_SIZE, CONV2_SIZE], scope='layer3-conv2', stride=1)
        pool2 = slim.max_pool2d(conv2, [2, 2], scope='layer4-pool2', stride=2)
